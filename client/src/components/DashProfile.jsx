...
export default function DashProfile() {
    ...
    const uploadImage = async () => {
        ...
        formData.append('upload_preset', import.meta.env.VITE_CLOUDINARY_UPLOAD_PRESET);  // Use the environment variable
        ...
        try {
            ...
            setImageFileUrl(data.secure_url); // Cloudinary provides the image URL here
            setFormData({ ...formData, profilePicture: data.secure_url });
            setImageFileUploading(false); // Set uploading state to false once upload completes
        } catch (error) {
